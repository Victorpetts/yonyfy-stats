...
import HandbollsLogo from '../img/newHandbollsLogo.png';
    ...
    return (
      <Router>
          <div>
            ...
            <img className="newLogo" src={HandbollsLogo} alt='first place' height="120" />
            ...
            <Switch>
              <Route path={`${this.props.match.path}/omgang`} render={(props) => <RoundsContainer {...props} league={27} customer={"handbollsligan"}/>} />
              <Route path={`${this.props.match.path}/sasong`} render={(props) => <SeasonContainer {...props} league={27} customer={"handbollsligan"}/>} />
